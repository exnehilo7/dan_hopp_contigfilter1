...
This sample module contains one small method that filters contigs.
    ...
    def run_Dan_hopp_contigfilter1(self, ctx, params):
        """
        ...
        #BEGIN run_Dan_hopp_contigfilter1

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_Dan_hopp_contigfilter1 function. Params=' + pformat(params))
        ...
        #END run_Dan_hopp_contigfilter1

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_Dan_hopp_contigfilter1 return value ' +
